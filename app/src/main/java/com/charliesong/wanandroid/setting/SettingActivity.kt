...
class SettingActivity: BaseActivity(){
    ...
    var txts= arrayListOf<String>("<font color=#ff0000> 第一个 </font>aaaa",
            "<![CDATA[222<font color= #ff0000;> 第2个 </font>222 ]]>"
            ,".............")
    var num=0
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       tv_test.setText(Html.fromHtml(getString(R.string.test)))
    ...
    fun setLoginButton(){
        btn_login.apply {
          val  name=NormalUtil.checkCookie(this@SettingActivity)
